...
from recipe_shelf.cli import main
from recipe_shelf.models import Note, ProjectState, Task
from recipe_shelf.cli import demo_state
from recipe_shelf.storage import load_state, save_state
from recipe_shelf.models import generate_short_id
from recipe_shelf.validation import normalize_tags, require_text, validate_task_status
from recipe_shelf.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
